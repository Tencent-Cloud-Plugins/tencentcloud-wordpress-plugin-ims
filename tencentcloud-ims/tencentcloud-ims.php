...
Author: 腾讯云
 */
defined('TENCENT_WORDPRESS_IMS_VERSION')||define( 'TENCENT_WORDPRESS_IMS_VERSION', '1.0.1');
...
defined('TENCENT_WORDPRESS_IMS_JS_DIR')||define( 'TENCENT_WORDPRESS_IMS_JS_DIR', TENCENT_WORDPRESS_IMS_URL . '/js/' );
defined('TENCENT_WORDPRESS_IMS_CSS_DIR')||define( 'TENCENT_WORDPRESS_IMS_CSS_DIR', TENCENT_WORDPRESS_IMS_URL . '/css/' );
//插件中心常量
...
defined('TENCENT_WORDPRESS_PLUGINS_COMMON_URL')||define('TENCENT_WORDPRESS_PLUGINS_COMMON_URL', TENCENT_WORDPRESS_IMS_URL . '/common/');
